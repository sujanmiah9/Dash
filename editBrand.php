<?php
    ...
    if(isset($_POST['update'])){
        ...
        $sql  = "UPDATE `add_brand` SET `name`=:namee,`description`=:descript WHERE id = :id";
        $stmt = $db->prepare($sql);
        $stmt->bindParam(':id',$id,PDO::PARAM_STR);
            ...
            <div class="card">
                <div class="card-header text-white bg-secondary">
                    ...
                    <span class="float-right">
                        <a href="viewBrand.php" class="text-white">
                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="submit" class="btn btn-secondary float-right" name="update" value="Update Brand">
                        </div>
                    </form>
                </div>
            </div>
